        ...
        <![endif]-->
            ...
            <div style="max-width: 600px; margin: 0 auto;" class="email-container">
                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                    style="margin: auto;border-top: 4px solid #1DB47B;">
                    <!-- Email Header : BEGIN -->
                    <tr>
                    ...
                    <tr>
                        <td style="background-color: #333333;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td
                                        style="padding: 20px; font-family: sans-serif; font-size: 12px; line-height: 20px; color: #555555;">
                                        <p style="margin: 0;font-weight: bold;color: #fff;">{{ config('app.name', 'Laravel') }}</p>
                                        <p style="color: #fff;">
                                            Email:<br>
                                            Phone:<br>
                                            Address:<br>

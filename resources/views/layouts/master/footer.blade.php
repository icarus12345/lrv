...
<div class="footer-area">
						...
						<div class="footer-info contact">
							<ul class="toggle-footer">
								<li>
									...
									<p>39 Luong Huu Khanh, Pham Ngu Lao Ward<br /> District 01, HCMC</p>
								</li>
								<li>
									<i class="fa fa-phone"></i>
									<p>Telephone: (+84)28 3925 9299 <br />Fax: (+84)28 3832 8066</p>
								</li>
								<li>
									<i class="fa fa-envelope-o"></i>
									Email: support@gid.com
								</li>
								<li>
									<i class="fa fa-globe"></i>
								   Website: www.gid.asia
								</li>
							</ul>								
						</div>
					</div>
					...
					<div class="time-area">
						...
						<ul class="toggle-footer">
							<li>
								...
								<span class="pull-right">9:00 - 17:30</span>
							</li>
							<li>
	...
	<div class="footer-bottom-area">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<p>Copyright <a href="bon-cd.com">BON DESIGN</a> All rights reserved.</p>						
				</div>
			</div>
		</div>
	</div>
